...
class HabitTile extends StatelessWidget {
  ...
  String formatToMinSec(int totalSeconds) {
    String secs = (totalSeconds % 60).toString(); // 62 % 60 = 2
    String mins = (totalSeconds / 60).toStringAsFixed(1);
    // 59 seconds -> 0:59
    // (59/60).toStringAsFixed(1) = 0.9xxxx
    // (59/60).toStringAsFixed(0) = 1  (round 함수 속성)

    // if secs is 1 1 digit number
    if (secs.length == 1) {
      secs = '0$secs';
    }
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    // progress
                    Text(
                      '${formatToMinSec(timeSpent)} / $timeGoal min = ${(percentCompleted() * 100).toStringAsFixed(0)}%',
